        ...
        <div className=" cursor-pointer relative p-px overflow-hidden transition w-full duration-300 transform border rounded shadow-sm hover:scale-105 group hover:shadow-xl">
          ...
          <div className="relative p-5 h-full bg-white  rounded-sm">
            <div className="flex flex-col mb-2 lg:items-center lg:flex-row">
              ...
              <h6 className="font-semibold leading-5">Direito empresarial</h6>
            </div>
            <p className="mb-2 text-sm text-gray-900">Evite dores de cabeça e diminua sua carga tributária através de nossos serviços para empresas.</p>
        ...
        <div className=" cursor-pointer relative p-px overflow-hidden h-full transition duration-300 transform border rounded shadow-sm hover:scale-105 group hover:shadow-xl">
          ...
          <div className="relative p-5 bg-white  h-full rounded-sm">
            <div className="flex flex-col mb-2 lg:items-center lg:flex-row">
              ...
              <h6 className="font-semibold leading-5">Direito Cível / Família</h6>
            </div>
            <p className="mb-2 text-sm text-gray-900">Proteja seus direitos e de seus familiares. Fale com um de nossos advogados.</p>
            <a className="inline-flex items-center text-sm font-semibold transition-colors duration-200 text-deep-purple-accent-400 hover:text-deep-purple-800">Learn more</a>
          </div>
        </div>
        <div className="cursor-pointer relative p-px overflow-hidden transition duration-300 transform border rounded shadow-sm hover:scale-105 group hover:shadow-xl">
          ...
          <div className="relative p-5 bg-white  h-full rounded-sm">
            <div className="flex flex-col mb-2 lg:items-center lg:flex-row">
              ...
              <h6 className="font-semibold leading-5">Direto do trabalho</h6>
            </div>
            <p className="mb-2 text-sm text-gray-900">Seu direito trabalhista é de extrema importância para nós. Fale conosco e exerça seus direitos.</p>
            <a className="inline-flex items-center text-sm font-semibold transition-colors duration-200 text-deep-purple-accent-400 hover:text-deep-purple-800">Learn more</a>
          </div>
        </div>
        <div className=" cursor-pointer relative p-px overflow-hidden transition duration-300 transform border rounded shadow-sm hover:scale-105 group hover:shadow-xl">
          ...
          <div className="relative p-5  bg-white rounded-sm">
            <div className="flex flex-col mb-2 lg:items-center lg:flex-row">
              ...
              <h6 className="font-semibold leading-5">Direitos autorais</h6>
            </div>
            <p className="mb-2 text-sm text-gray-900">Todo criador tem direitos sobre a sua criação. Saiba como portegê-la e como podemos ajudar.</p>
