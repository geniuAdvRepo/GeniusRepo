            ...
            >
              ...
              <div className="relative p-5 h-full bg-white  rounded-sm">
                <div className="flex flex-col mb-2 lg:items-center lg:flex-row">
                  ...
                  <h6 className="font-semibold text-black  leading-5 text-sm lg:text-lg">
                    {item.title}
                  </h6>
                </div>
                <h6 className=" text-black leading-10 text-sm lg:text-md">
                  {item.subtitle}
                </h6>
                <p className="mb-2 text-sm text-gray-900 lg:text-md">
                  {item.text}
                </p>
              </div>
            </button>
